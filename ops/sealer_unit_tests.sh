...
if [[ -z "${SEAL_UNSEAL_VALIDATION_HASH}" ]]; then
  SEAL_UNSEAL_VALIDATION_HASH=aa5ef33a968701d06efa0ef5dafb6ba4789a31a7d1c2c259cc3f7f8dbe05c004174720d1b0aa57681bbb889d5199e51ef6ca4afcf5886682db2dfee713d69a8c
fi
...
echo here we are
echo $SEAL_UNSEAL_VALIDATION_HASH
